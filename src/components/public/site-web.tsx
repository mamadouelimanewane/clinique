import { resetAdminPassword } from "@/app/login/actions";
"use client"
        ...
        <div className="min-h-screen bg-[#fafafa] text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900">
                    ...
                    <div className="bg-white/70 backdrop-blur-2xl border border-white/20 rounded-[32px] px-8 h-20 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.05)]">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xl font-black tracking-tighter text-slate-900 leading-none">AÃ‰RÃ‰ LAO</span>
                        ...
                        <div className="hidden md:flex items-center gap-10 text-sm font-bold text-slate-500">
                            ...
                            <Link href="#specialites" className="hover:text-indigo-600 transition-all hover:scale-105">SpÃ©cialitÃ©s</Link>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-10 relative z-10">
                        <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 rounded-full px-5 py-2">
                            ...
                            <span className="text-xs font-black text-indigo-700 uppercase tracking-widest">L'avenir de la santÃ© est ici</span>
                        </div>

                        <h1 className="text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter text-slate-900">
                            La Clinique du <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-emerald-500">Futur</span> est Ã  AÃ©rÃ© Lao.
                        </h1>

                        <p className="text-xl text-slate-500 max-w-xl font-medium leading-relaxed">
                            Vivez une expÃ©rience mÃ©dicale augmentÃ©e oÃ¹ l'intelligence artificielle et l'expertise humaine s'unissent pour votre bien-Ãªtre.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <Link href="/rendez-vous">
                                <Button size="lg" className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-[24px] px-10 h-16 text-lg font-black shadow-2xl shadow-indigo-200 transition-all hover:scale-105 group">
                                    RÃ©server mon soin <ArrowRight className="ml-2 h-6 w-6 group-hover:translate-x-2 transition-transform" />
                                </Button>
                            </Link>
                        ...
                        <div className="flex items-center gap-8 pt-6 border-t border-slate-100">
                            ...
                            <p className="text-sm font-bold text-slate-500">
                                <span className="text-indigo-600 font-black">25+ Experts</span> disponibles dÃ¨s maintenant
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative aspect-[4/5] rounded-[50px] overflow-hidden border-[12px] border-white shadow-[0_32px_64px_rgba(0,0,0,0.12)] rotate-2 group-hover:rotate-0 transition-all duration-700">
                            <Image
                                ...
                                alt="Futuristic Clinique AÃ©rÃ© Lao"
                                fill
            ...
            <section id="vison" className="py-32 bg-slate-900 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { title: "Dashboard Patient", icon: UserCircle, desc: "AccÃ©dez Ã  vos rÃ©sultats et ordonnances en temps rÃ©el depuis votre mobile.", val: "100%", label: "Digital" },
                            { title: "IA Diagnostics", icon: Microscope, desc: "Analyse prÃ©dictive pour des diagnostics d'une prÃ©cision inÃ©galÃ©e.", val: "99.9%", label: "PrÃ©cision" },
                            { title: "TÃ©lÃ©mÃ©decine", icon: Globe, desc: "Consultez nos meilleurs spÃ©cialistes oÃ¹ que vous soyez.", val: "24h/7", label: "AccÃ¨s" },
                            { title: "Bio-Tech Lab", icon: Zap, desc: "Analyses gÃ©nÃ©tiques et biologiques haute performance.", val: "<2h", label: "RÃ©sultats" }
                        ].map((stat, i) => (
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                        <div className="max-w-2xl space-y-4">
                            <Badge className="bg-indigo-600 text-white rounded-full px-4 py-1 hover:bg-indigo-700">DÃ©partements</Badge>
                            <h2 className="text-5xl font-black tracking-tight text-slate-900">Une expertise multidisciplinaire pour chaque <span className="text-indigo-600">gÃ©nÃ©ration</span>.</h2>
                        </div>
                        <Button variant="outline" className="h-14 px-8 rounded-2xl border-2 border-slate-100 font-bold hover:bg-slate-50">DÃ©couvrir tous les pÃ´les</Button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {[
                            ...
                            { icon: Stethoscope, title: "Chirurgie", color: "from-indigo-500/20 to-indigo-500/5", textColor: "text-indigo-600", desc: "Blocs opÃ©ratoires ultra-modernes et micro-chirurgie." },
                            { icon: ShieldCheck, title: "Ophtalmologie", color: "from-emerald-500/20 to-emerald-500/5", textColor: "text-emerald-600", desc: "Correction laser et chirurgie oculaire assistÃ©e par IA." }
                        ].map((item, i) => (
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="bg-slate-900 rounded-[60px] p-12 md:p-24 relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="space-y-6 relative z-10 max-w-xl">
                            <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">PrÃªt pour votre <span className="text-emerald-400 underline decoration-indigo-500 underline-offset-8">check-up</span> ?</h2>
                            <p className="text-slate-400 text-lg font-medium">Rejoignez les 15,000 patients qui font confiance Ã  notre technologie chaque annÃ©e.</p>
                        </div>
            ...
            <footer className="bg-white border-t border-slate-100 pt-24 pb-12">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-20 mb-20">
                    <div className="space-y-8">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-2xl font-black tracking-tighter">AÃ‰RÃ‰ LAO</span>
                        </div>
                        <p className="text-slate-500 font-medium leading-relaxed">RedÃ©finir le standard des soins mÃ©dicaux en Afrique avec l'innovation digitale.</p>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-slate-600 font-bold">
                            <li><Link href="#" className="hover:text-indigo-600 transition-colors">L'Ã‰quipe MÃ©dicale</Link></li>
                            <li><Link href="#" className="hover:text-indigo-600 transition-colors">Infrastructures</Link></li>
                            <li><Link href="#" className="hover:text-indigo-600 transition-colors">CarriÃ¨res</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-4 text-slate-600 font-bold">
                            ...
                            <li><Link href="#" className="hover:text-indigo-600 transition-colors">Conseils SantÃ©</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 text-slate-600 font-bold">
                            <p className="flex items-start gap-2">AÃ©rÃ© Lao, Fouta - SÃ©nÃ©gal</p>
                ...
                <div className="max-w-7xl mx-auto px-6 pt-12 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Â© 2026 AÃ‰RÃ‰ LAO Medical Hub. Excellence beyond borders.</p>
                    <div className="flex gap-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                        <Link href="#" className="hover:text-indigo-600">PrivacitÃ©</Link>
